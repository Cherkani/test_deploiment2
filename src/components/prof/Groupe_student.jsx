...
const Groupe = () => {
  ...
  const handleUpdate = (id, code, year) => {
    setUpdateMode(true);
    setMajor({ id: id, code: code, year: year });
  };
  ...
  return (
    <div className="flex">
      ...
      <div className="flex flex-col items-center w-5/6 ml-[90px] ">
        <p className=" m-12 text-4xl font-bold bg-white w-full py-4 pl-12 rounded-xl text-black-500 shadow-xl border border-gray-300 ">
          {" "}
          <span>
        ...
        {loading ? (
          ...
          <div className="flex items-start justify-center w-full m-10">
            <Statistiques />
            <div className="ml-10 flex flex-col p-10 w-2/3  shadow-xl justify-center items-center border border-black-300 rounded-xl bg-white">
              <div className="flex flex-col w-full">
                ...
                {majors.map((major, index) => (
                  <div className="flex items-center w-full text-lg text-gray-700 bg-gray-50 border-b py-3">
                    ...
                    <p className="text-center w-1/4">{major.year}</p>
                    <div className="flex justify-center w-1/4">
                      <button
                        onClick={() =>
                          handleUpdate(major.id, major.code, major.year)
                        }
                      >
                        <FontAwesomeIcon
                          icon={faPen}
